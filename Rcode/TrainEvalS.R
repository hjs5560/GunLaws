...
# Read data set 
data <- fread('./project/volume/data/interim/SLaw.csv')
...
names(z_scores_df)[15] <- "1stepSlopeZscore"
names(z_scores_df)[16] <- "2stepSlopeZscore"
names(z_scores_df)[17] <- "3stepSlopeZscore"
names(z_scores_df)[18] <- "4stepSlopeZscore"
names(z_scores_df)[19] <- "5stepSlopeZscore"
names(z_scores_df)[20] <- "6stepSlopeZscore"
names(z_scores_df)[21] <- "7stepSlopeZscore"
names(z_scores_df)[22] <- "8stepSlopeZscore"
names(z_scores_df)[23] <- "9stepSlopeZscore"
names(z_scores_df)[24] <- "10stepSlopeZscore"
names(z_scores_df)[25] <- "11stepSlopeZscore"
names(z_scores_df)[26] <- "12stepSlopeZscore"
names(z_scores_df)[27] <- "13stepSlopeZscore"
names(z_scores_df)[28] <- "14stepSlopeZscore"
...
fwrite(final,'./project/volume/data/interim/EvalS.csv')
